...
public class ClanContribution {
    ...
    public void internalCollectChests() {
        ...
        Transformation transformation = Transformation.builder()
                .real(titleMyClanPoint)
                .reference(Point.of(963, 325))
                .build();
        ...
        robot.leftClick(transformation.transform(Point.of(1354, 863)));
        robot.sleep(500);
        // Just click on collect all!
        
        Navigate.builder()
                .resourceName("player/my_clan/button_continue.png")
                .waitLimit(3000)
                .build()
                .leftClickIfExists();
    ...
    public void helpClanMembers() {
        ...
        if (point != null) {
            log.info("Clicked on help allies icon");
